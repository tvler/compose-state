  ...
  return function () {
    ...
    return updaters.reduceRight(function (accumulator, current) {
      return function (stateOrProps1, stateOrProps2) {
        ...
        var currentState = current instanceof Function ? stateIndex === 0 ? current(_objectSpread(_objectSpread({}, stateOrProps1), accumulatedState), stateOrProps2) : current(stateOrProps1, _objectSpread(_objectSpread({}, stateOrProps2), accumulatedState)) : current;
        return currentState || accumulatedState ? _objectSpread(_objectSpread({}, accumulatedState), currentState) : null;
      };
    }, function () {
      return null;
    });
